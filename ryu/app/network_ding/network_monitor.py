        ...
        for src in paths:
            for dst in paths[src]:
                ...
                for path in paths[src][dst]:
                    ...
                    paths_des[tuple(path)] = min_bw


                best_paths[src][dst] = [ele[0] for ele in sorted(paths_des.items(),key=lambda d:d[1],reverse=True)]
                paths_des.clear()
                ...
                for stat in sorted(
                    ...
                    print('%016x %8x %17s %8x %8d %8d %8.1f' % (
                        ...
                        abs(self.flow_speed[dpid][
                            ...
                            stat.instructions[0].actions[-1].port)][-1])))
            print '\n'
